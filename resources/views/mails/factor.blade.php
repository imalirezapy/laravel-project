...
<body dir="rtl">
                        ...
                        <div class="col-4">
                            <p>نام شخص حقیق / حقوقی: {{$factor->user->name}}</p>
                            <p>آدرس کامل:{{$factor->factor_profile}}</p>
                        </div>
                        <div class="col-4">
                            <p>مبلغ پرداختی:{{$factor->final_total}}</p>
                            <p>کد پستی:{{$factor->factor_profile}}</p>
                        </div>
                        <div class="col-4">
                            <p>شماره ثبت / شناسه ملی:</p>
                            <p>تلفن / نمابر:{{$factor->user->profile->phone}}</p>
                        </div>
